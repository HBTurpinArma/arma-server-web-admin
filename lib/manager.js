...
Manager.prototype.canUserView = function(user) {
  return this.config.auth[user].permissions.servers.view || false
}

Manager.prototype.canUserEdit = function(user) {
  return this.config.auth[user].permissions.servers.edit || false
}

Manager.prototype.canUserCreate = function(user) {
  return this.config.auth[user].permissions.servers.create || false
}

Manager.prototype.canUserDelete = function(user ){
  return this.config.auth[user].permissions.servers.delete || false
}

Manager.prototype.canUserStart = function(user) {
  return this.config.auth[user].permissions.servers.start || false
}

Manager.prototype.canUserStop = function(user) {
  return this.config.auth[user].permissions.servers.stop || false
}

Manager.prototype.canUserRCON = function(user) {
  return this.config.auth[user].permissions.servers.rcon || false
}
