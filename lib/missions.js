...
var Missions = function (config) {
  this.config = config
  this.missions = []
  this.steamWorkshop = new SteamWorkshop(this.missionsPath("arma3_x64"))
...
Missions.prototype.missionsPath = function (gameKey) {
  console.log(this.config.games, gameKey)
  return path.join(this.config.games[gameKey].path, 'mpmissions')
}
