...
Missions.prototype.canUserView = function(user) {
  return this.config.auth[user].permissions.missions.view || false
}

Missions.prototype.canUserCreate = function(user){
  return this.config.auth[user].permissions.missions.create || false
}

Missions.prototype.canUserDelete = function(user){
  return this.config.auth[user].permissions.missions.delete || false
}
